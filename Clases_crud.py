...
class Persona:
    def __init__(self, rut: str, nombres: str, apellidos: str, fecha_nacimiento: date, cod_area: int, telefono: int):
        self.rut: str = rut
...
def create_persona():
    ...
    personas = Persona(rut=rut, nombres=nombres, apellidos=apellidos, fecha_nacimiento=fecha_nacimiento, cod_area=cod_area, telefono=telefono, persona=persona)
        ...
        if persona.rut == rut_busqueda:
            while True:
                ...
                if opcion == "1":
                    ...
                    print("Apellidos modificado exitosamente")
                elif opcion == "4":
                    dia_nacimiento = int(input("Ingresa el dia de nacimiento de la persona: "))
                    mes_nacimiento = int(input("Ingresa el mes de nacimiento de la persona: "))
                    anio_nacimiento = int(input("Ingresa el año de nacimiento de la persona: "))
